                        ...
                        <tr>
                            ...
                            <td>
                                <a style="padding: 0.5em" class="btn btn-outline-primary"
                                    href="{{ route('admin.user.edit', $item->id) }}"><i class="bx bx-edit-alt me-1"></i>
                                    Sửa</a>
                                <a style="padding: 0.5em" class="btn btn-outline-danger"
                                    href="{{ route('admin.user.destroy', $item->id) }}" data-id="{{ $item->id }}"
                    ...
                    case '0':
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                let token = $('meta[name=token]').attr('content');
                                let url = "{{ route('admin.user.destroy.list') }}"
                                $.ajax({
                                    type: "post",
                                    url: url,
                                    data: {
