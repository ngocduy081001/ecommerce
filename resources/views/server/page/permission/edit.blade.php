...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-body">
                    <form id="form" action="{{ route('admin.category.update', [$data->id]) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="description" name="alt" class="form-control phone-mask"
                                    placeholder="Nhập mô tả danh mục" value="{{ $data->alt }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="select" name="parent" class="form-control"
                                    placeholder="Lựa chọn vị trí" id="parent" value="{{ $data->parent }}">
                            </div>
