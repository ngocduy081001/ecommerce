        ...
        <div class="row px-xl-5">
            <div class="col-lg-8">
                <div class="mb-4">
                    ...
                    <form action="{{ route('cart.post.check.out') }}" method="post" id="form-checkout">
                        @csrf
                        <input type="hidden" name="cast_total" value="{{$cast_total}}">
                        <div class="row">
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        ...
                        @foreach ($cart as $item)
                            <div class="d-flex justify-content-between">
                                ...
                                <p>@convert($item['quantity'] * $item['price']) VND</p>
                        ...
                        <div class="d-flex justify-content-between mb-3 pt-1">
                            ...
                            <h6 class="font-weight-medium">@convert($cast_total) VND</h6>
                        </div>
                        <div class="d-flex justify-content-between">
                    ...
                    <div class="card-footer border-secondary bg-transparent">
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <h5 class="font-weight-bold">@convert($cast_total) VND</h5>
                        </div>
                    </div>
                </div>
                <div class="card border-secondary mb-5">
