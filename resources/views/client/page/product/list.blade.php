...
@section('content')
    @isset($slug)
        <input type="hidden" name="category" id="category" value="{{ $slug }}">
    @endisset
    <!-- Page Header Start -->
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">
            ...
            <!-- Shop Sidebar Start -->
            @include('client.page.product.side-bar')
            <!-- Shop Sidebar End -->
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    ...
                    <div class="row" id="list">
                        @include('client.page.product.item')

                    </div>

                    @include('client.page.product.paginate')
