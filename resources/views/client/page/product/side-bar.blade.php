<div class="col-lg-3 col-md-12">
    ...
    <div class="border-bottom mb-4 pb-4">
        ...
        <form action="{{ route('product.filter') }}" method="get" id="form-filter">           
            ...
            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                ...
                <span class="badge border font-weight-normal">{{ $product_0 }}</span>
            </div>
            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                ...
                <span class="badge border font-weight-normal">{{ $product_1 }}</span>
            </div>
            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                ...
                <span class="badge border font-weight-normal">{{ $product_2 }}</span>
            </div>
            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                ...
                <span class="badge border font-weight-normal">{{ $product_3 }}</span>
            </div>
            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between">
                ...
                <span class="badge border font-weight-normal">{{ $product_4 }}</span>
            </div>
    ...
    <div class="border-bottom mb-4 pb-4">
        ...
        @foreach ($color as $item)
            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                <input onclick="return filter(this)" value="{{ $item->name }}" name="color[]" type="checkbox"
                    class=" color custom-control-input" id="color-{{ $item->id }}">
                <label class="custom-control-label" for="color-{{ $item->id }}">{{ $item->name }}</label>
                <span class="badge border font-weight-normal">{{ count($item->hasProduct) }}</span>
            </div>
        @endforeach
    ...
    <div class="mb-5">
        ...
        @foreach ($size as $item)
            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                <input onclick="return filter(this)" name="size[]" value="{{ $item->name }}" type="checkbox"
                    class="size custom-control-input" id="size-{{ $item->id }}">
