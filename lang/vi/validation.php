...
return [
    ...
    | lớp trình xác thực. Một số quy tắc có nhiều phiên bản như
    | quy tắc kích thước. Hãy thoải mái điều chỉnh từng thông báo ở đây.
    |
    */
    ...
    'ascii'           => 'Trường :attribute chỉ được chứa các ký tự và ký hiệu ASCII đơn byte.',
    ...
    | sử dụng quy ước "attribute.rule" để đặt tên cho các dòng. Điều này giúp
    | bạn nhanh chóng chỉ định một dòng ngôn ngữ tùy chỉnh cụ thể cho một quy tắc thuộc tính.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Các dòng ngôn ngữ sau đây được sử dụng để thay thế chỗ giữ chỗ thuộc tính
    | của chúng tôi bằng một cái gì đó thân thiện hơn với người đọc như "Địa chỉ E-Mail"
    | thay vì "email". Điều này giúp chúng tôi làm cho thông điệp của mình rõ ràng hơn.
    |
    */
