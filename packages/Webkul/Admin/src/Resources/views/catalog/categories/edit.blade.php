                ...
                <x-admin::accordion>
                    ...
                    <x-slot:content>
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="text" name="position" rules="required|integer"
                        ...
                        <x-admin::form.control-group>
                            <x-admin::form.control-group.label
                                class="required font-medium text-gray-800 dark:text-white">
                        ...
                        <x-admin::form.control-group class="!mb-0">
                            <x-admin::form.control-group.label>
                                @lang('admin::app.catalog.categories.edit.visible-in-home-page')
                            </x-admin::form.control-group.label>

                            @php $selectedValue = old('home') ?: $category->home @endphp

                            <!-- Visible in menu Hidden field -->
                            <x-admin::form.control-group.control type="hidden" class="cursor-pointer" name="home"
                                :checked="(bool) $selectedValue" />

                            <x-admin::form.control-group.control type="switch" class="cursor-pointer" name="home"
                                value="1" :label="trans('admin::app.catalog.categories.edit.visible-in-home-page')" :checked="(bool) $selectedValue" />
                        </x-admin::form.control-group>
                    </x-slot>
                </x-admin::accordion>
                        ...
                        @foreach ($attributes as $attribute)
                            <x-admin::form.control-group class="!mb-2 flex items-center gap-2.5 last:!mb-0">
                                <x-admin::form.control-group.control type="checkbox" :id="$attribute->name ?? $attribute->admin_name"
                                    ...
                                    :label="trans('admin::app.catalog.categories.edit.filterable-attributes')" :checked="in_array($attribute->id, $selectedAttributes)" />

                                <label class="cursor-pointer text-xs font-medium text-gray-600 dark:text-gray-300"
