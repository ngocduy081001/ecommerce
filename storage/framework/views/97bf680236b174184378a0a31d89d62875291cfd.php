...
<?php $__env->startSection('content'); ?>
    <div class="card" style="margin-bottom: 30px">
        <h5 class="card-header">Hành động & Bộ lọc
            <a href="<?php echo e(route('admin.product.create')); ?>">Thêm mới</a>
        </h5>
        <div class="row">
            <div class="col-sm-3">
                            ...
                            <td>
                                <div class="form-check form-switch mb-2">
                                    <input class="form-check-input" type="checkbox" id="status"
                                        data-id="<?php echo e($item->id); ?>" onchange="return changeStatus(this)"
                                        value="<?php echo e($item->status); ?>" <?php echo e($item->status == 1 ? 'checked' : ''); ?>>
                                </div>
                            </td>
                            <td>
                                ...
                                <a style="padding: 0.5em" class="btn btn-outline-primary"
                                    href="<?php echo e(route('admin.product.edit', $item->id)); ?>"><i class="bx bx-edit-alt me-1"></i>
                                    Sửa</a>
                                <a style="padding: 0.5em" class="btn btn-outline-danger"
                                    href="<?php echo e(route('admin.product.destroy', $item->id)); ?>" data-id="<?php echo e($item->id); ?>"
...
<?php $__env->startSection('page-js'); ?>
    <script>
        function changeStatus(e) {
            ...
            var url = "<?php echo e(route('admin.category.status', ':id')); ?>";
                    ...
                    case '0':
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                let token = $('meta[name=token]').attr('content');
                                let url = "<?php echo e(route('admin.category.destroy.list')); ?>"
                                $.ajax({
                                    type: "post",
                                    url: url,
                                    data: {
...
<?php echo $__env->make('server.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web_ban_hang\ecommerce\resources\views/server/page/product/grid.blade.php ENDPATH**/ ?>