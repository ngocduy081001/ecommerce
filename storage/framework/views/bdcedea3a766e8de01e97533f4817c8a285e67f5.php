...
<?php $__env->startSection('content'); ?>
    <div class="card" style="margin-bottom: 30px">
        <h5 class="card-header">Hành động & Bộ lọc <a href="<?php echo e(route('admin.category.create')); ?>">Thêm mới</a></h5>
        <div class="row">
            <div class="col-sm-3">
...
<?php echo $__env->make('server.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web_ban_hang\ecommerce\resources\views/server/page/category/grid.blade.php ENDPATH**/ ?>