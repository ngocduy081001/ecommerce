...
<head>
    ...
    <title><?php echo e(trans('filemanager::filemanager.title')); ?></title>
    <link rel="stylesheet" href="<?php echo e(asset('filemanager/bundle/app.min.css')); ?>">
    <style type="text/css">
        [ng\:cloak],
        [ng-cloak],
        [data-ng-cloak],
    ...
    <script>
        window.translations = <?php echo collect(trans('filemanager::filemanager'))->toJson(); ?>

    </script>
</head>

<body ng-cloak ng-controller="FilemanagerCtrl" class="<?php echo e(config('app.locale')); ?>">
    <header>
        <h2 class="app_title"><img src="<?php echo e(asset('filemanager/img/logo.png')); ?>"
                alt=""><span><?php echo e(trans('filemanager::filemanager.title')); ?></span></h2>

        <div class="right">
            <button class="btn_bulk_actions danger" ng-click="bulkDelete()" ng-show="checkedIds.length>1"
                ng-disabled="bulkDeleting" ladda="bulkDeleting"><?php echo e(trans('filemanager::filemanager.bulk-delete')); ?>

                ({{ checkedIds.length }})
            </button>

            <div class="search_box">
                <input type="text" placeholder="<?php echo e(trans('filemanager::filemanager.search')); ?>" ng-model="q"
                    ng-model-options="{debounce:500}" ng-change="init(q)">
                <div class="searching" ng-show="searching">
                    <img src="<?php echo e(asset('filemanager/img/ajax-loader.gif')); ?>" alt="loader" />
                </div>
            ...
            <a class="btn-doc" href="https://laravelarticle.com/laravel-simple-filemanager"><i
                    class="fa fa-info-circle"></i> <?php echo e(trans('filemanager::filemanager.doc')); ?></a>
        </div>
    </header>
    <!--custom preview-->
    ...
    <div class="wrapper">
        <div class="sidebar">
            <button class="btn_mobile_upload success" ng-click="mobileUploadOpen=1"><i class="fa fa-upload"></i>
                <?php echo e(trans('filemanager::filemanager.upload')); ?>
            ...
            <div class="gallery">
                ...
                <div class="gl_item gl_header">
                    <div class="name">
                        ...
                        <?php echo e(trans('filemanager::filemanager.name')); ?>

                    </div>
                    <div class="size"><?php echo e(trans('filemanager::filemanager.size')); ?></div>
                    <div class="type"><?php echo e(trans('filemanager::filemanager.type')); ?></div>
                    <div class="modified"><?php echo e(trans('filemanager::filemanager.modified')); ?></div>
                    <div class="action"><?php echo e(trans('filemanager::filemanager.action')); ?></div>
                </div>
                <!--end gallery header-->
                <!--single-->
                <div class="gl_item" ng-repeat="photo in photos"
                    ...
                    <div class="name">
                        ...
                        <div class="thum" ng-click="toggleCheck(photo.id)">
                            <img ng-if="photo.ext=='png' ||
                                    ...
                                    photo.ext=='webp' ||
                                    photo.ext=='gif'"
                                ng-src="<?php echo e($thumbUrl); ?>/{{ photo.name }}" alt="{{ photo.name }}">
                            ...
                            <p ng-if="photo.ext=='xls'||photo.ext=='xlsx'"><i class="fa fa-file-excel-o fa-2x"></i>
                            </p>
                    ...
                    <div class="action">
                        <?php echo $__env->make('filemanager::partials.action', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
                <!--single-->
                <!--load more-->
            ...
            <div class="content_footer">
                ...
                <div class="right">
                    <button type="button" ng-click="bulkSelect()" ng-if="bulkMode"
                        ng-disabled="!checkedIds.length"><?php echo e(trans('filemanager::filemanager.bulk-select')); ?>
        ...
        <!--mobile -->
        <?php echo $__env->make('filemanager::partials.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!--mobile -->

        <!--popup -->
        <?php echo $__env->make('filemanager::partials.popup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!--popup -->
    </div>

    <script src="<?php echo e(asset('filemanager/bundle/app.min.js')); ?>"></script>
    ...
    <script>
        ...
        filemanager.controller('FilemanagerCtrl', function($scope, $http, $q, $window, $timeout) {
            ...
            $scope.init = function(q) {
                ...
                if (q === '' || q === undefined) {
                    url = '<?php echo e(route('filemanager.base_route')); ?>?' + serialize(params)
                } else {
                    $scope.searching = true;
                    $scope.currentPage = 1;
                    url = '<?php echo e(route('filemanager.base_route')); ?>?action=files&page=1&q=' + q
                }
                $http.get(url)
            ...
            var defaultOptions = {
                url: '<?php echo e(route('filemanager.base_route')); ?>?action=upload',
                ...
                dictDefaultMessage: "<?php echo e(trans('filemanager::filemanager.upload-message')); ?>",
            ...
            $scope.dzCallbacks = {
                    ...
                    switch (ext) {
                        case "pdf":
                            $(file.previewElement).find("img").attr("src",
                                "/filemanager/img/previews/pdf.png");
                            break;
                        case "doc":
                        case "docx":
                            $(file.previewElement).find("img").attr("src",
                                "/filemanager/img/previews/doc.png");
                            break;
                        case "txt":
                            $(file.previewElement).find("img").attr("src",
                                "/filemanager/img/previews/txt.png");
                            break;
                        case "xls":
                        case "xlsx":
                            $(file.previewElement).find("img").attr("src",
                                "/filemanager/img/previews/xls.png");
                            break;
                        default:
                            break;
                    }
                ...
                'queuecomplete': function(files, xhr) {
                    ...
                    var oldText = "<?php echo e(trans('filemanager::filemanager.upload-message')); ?>";
                    el.text("<?php echo e(trans('filemanager::filemanager.success-upload')); ?>");
                    setTimeout(function() {
                        el.text(oldText)
                    }, 3000)
                    //flash message
            ...
            $scope.select = function(row) {
                ...
                if (urlParam('input_id')) {
                    if (window.opener.document.getElementById(urlParam('input_id'))) {
                        ...
                        let arr = row.absolute_url.split('/');
                        if (el.value !== 'undefined') el.value = arr[5];
                        ...
                        if (window.opener.document.getElementById(urlParam('input_id') + '-preview')) {
                            var previewEl = window.opener.document.getElementById(urlParam('input_id') +
                                '-preview');
            ...
            $scope.bulkDelete = function() {
                ...
                if (confirm("This action will delete " + $scope.checkedIds.length +
                        " number of files. Are you sure?")) {
                    $scope.bulkDeleting = true;

                    $scope.checkedIds.forEach(function(id) {
                        var promise = $http.post(
                        '<?php echo e(route('filemanager.base_route')); ?>?action=delete', {
                            'id': id
                        });
            ...
            $scope.deletePhoto = function(photo, index) {
                ...
                if (confirm("Are you sure?")) {
                    photo.deleting = true
                    $http.post('<?php echo e(route('filemanager.base_route')); ?>?action=delete', {
                            'id': photo.id
                        })
                        .success(function(data) {
                            console.log(data)
            ...
            $scope.updateName = function(row) {
                ...
                $http.post('<?php echo e(route('filemanager.base_route')); ?>?action=updateName', row)
                    .success(function(data) {
                        if (data.success) {
                            $scope.editNamePopup = false;
                            $scope.selected = {}
            ...
            $scope.convert = function(photo, format) {
                ...
                $http.post('<?php echo e(route('filemanager.base_route')); ?>?action=convert', photo)
                    .success(function(data) {
                        if (data.success) {
...
<?php /**PATH D:\web_ban_hang\ecommerce\vendor\haruncpi\laravel-simple-filemanager\src/views/index.blade.php ENDPATH**/ ?>