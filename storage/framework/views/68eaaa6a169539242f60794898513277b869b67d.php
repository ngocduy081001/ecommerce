    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            <div class="col-lg-5 pb-5">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <?php $__currentLoopData = $product->colorSize; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($key == 0): ?>
                                <div class="carousel-item active">
                                    <img class="w-100 h-100" src="<?php echo e(asset('filemanager/uploads/' . $item->image)); ?>"
                                        alt="Image">
                                </div>
                            <?php else: ?>
            ...
            <div class="col-lg-7 pb-5">
                ...
                <h3 class="font-weight-semi-bold mb-4"><?php echo number_format($product->price, 0, ',', '.'); ?> VND</h3>
                <p class="mb-4"><?php echo $product->detail; ?>

                </p>
                <div class="d-flex mb-3">
                    <p class="text-dark font-weight-medium mb-0 mr-3">Kích thước:</p>
                    <form id="form-add-to-cart" action="<?php echo e(route('car.add.to.cart')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php $__currentLoopData = $product_size; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" class="custom-control-input" id="size-<?php echo e($item->id); ?>"
                                    name="size" value="<?php echo e($item->id); ?>">
                                <label class="custom-control-label"
                                    for="size-<?php echo e($item->id); ?>"><?php echo e($item->size->name); ?></label>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class="d-flex mb-4">
                    ...
                    <?php $__currentLoopData = $product_color; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="color-<?php echo e($item->id); ?>"
                                value="<?php echo e($item->id); ?>" name="color">
                            <label class="custom-control-label"
                                for="color-<?php echo e($item->id); ?>"><?php echo e($item->color->name); ?></label>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = $product_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="card product-item border-0">
                            <div
                                ...
                                <img class="img-fluid w-100" src="<?php echo e(asset('filemanager/uploads/' . $item->image)); ?>"
...
<?php echo $__env->make('client.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web_ban_hang\ecommerce\resources\views/client/page/product/detail.blade.php ENDPATH**/ ?>